...
export default function Signup() {
  function handleSubmit(e) {
    ...
    // to get all form data and display as an object
    // where key is the input name and value the enetered by the user
    const form = Object.fromEntries(fd.entries());
    console.log('fd: ', form);
    // above code display all form fields except checkBox
    // below extract check box and add it in above form 
